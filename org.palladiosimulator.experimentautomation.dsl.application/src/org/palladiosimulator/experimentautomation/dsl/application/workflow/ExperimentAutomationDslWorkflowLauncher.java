...
public class ExperimentAutomationDslWorkflowLauncher extends
    ...
    protected ExperimentAutomationConfiguration deriveConfiguration(final ILaunchConfiguration configuration,
        ...
        final AbstractWorkflowConfigurationBuilder builder = new ExperimentAutomationDslLaunchConfigurationBasedConfigBuilder(
                configuration, mode);
