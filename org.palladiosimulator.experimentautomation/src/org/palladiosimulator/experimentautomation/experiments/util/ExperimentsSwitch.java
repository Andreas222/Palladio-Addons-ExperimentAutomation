    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ExperimentsPackage.OBJECT_MODIFICATION: {
				...
				if (result == null) result = caseModification(objectModification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ExperimentsPackage.NESTED_INTERVALS_DOUBLE_VALUE_PROVIDER: {
				...
				if (result == null) result = caseValueProvider(nestedIntervalsDoubleValueProvider);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExperimentsPackage.NESTED_INTERVALS_LONG_VALUE_PROVIDER: {
				...
				if (result == null) result = caseValueProvider(nestedIntervalsLongValueProvider);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ExperimentsPackage.SCHEDULING_POLICY2_DELAY_MODIFICATION: {
				...
				if (result == null) result = caseModification(schedulingPolicy2DelayModification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
