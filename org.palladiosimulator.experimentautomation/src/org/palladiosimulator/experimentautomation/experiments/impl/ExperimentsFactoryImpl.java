...
public class ExperimentsFactoryImpl extends EFactoryImpl implements ExperimentsFactory {
    ...
    public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ExperimentsPackage.OBJECT_MODIFICATION: return createObjectModification();
			case ExperimentsPackage.INITIAL_MODEL: return createInitialModel();
			case ExperimentsPackage.RECONFIGURATION_RULES_FOLDER: return createReconfigurationRulesFolder();
			case ExperimentsPackage.NESTED_INTERVALS_DOUBLE_VALUE_PROVIDER: return createNestedIntervalsDoubleValueProvider();
			case ExperimentsPackage.NESTED_INTERVALS_LONG_VALUE_PROVIDER: return createNestedIntervalsLongValueProvider();
			case ExperimentsPackage.SCHEDULING_POLICY2_DELAY_MODIFICATION: return createSchedulingPolicy2DelayModification();
			default:
    ...
    public NestedIntervalsDoubleValueProvider createNestedIntervalsDoubleValueProvider() {
		NestedIntervalsDoubleValueProviderImpl nestedIntervalsDoubleValueProvider = new NestedIntervalsDoubleValueProviderImpl();
    ...
    public NestedIntervalsLongValueProvider createNestedIntervalsLongValueProvider() {
		NestedIntervalsLongValueProviderImpl nestedIntervalsLongValueProvider = new NestedIntervalsLongValueProviderImpl();
