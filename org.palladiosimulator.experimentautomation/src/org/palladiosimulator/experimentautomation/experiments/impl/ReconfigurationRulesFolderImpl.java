 ...
 * @generated
 */
public class ReconfigurationRulesFolderImpl extends MinimalEObjectImpl.Container implements ReconfigurationRulesFolder {
    ...
    public void setFolderUri(String newFolderUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExperimentsPackage.RECONFIGURATION_RULES_FOLDER__FOLDER_URI, oldFolderUri, folderUri));
	}
