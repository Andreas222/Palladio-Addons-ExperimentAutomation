...
public class AbstractsimulationPackageImpl extends EPackageImpl implements AbstractsimulationPackage {
    ...
    public void initializePackageContents() {
		...
		initEReference(getAbstractSimulationConfiguration_Datasource(), this.getEDP2Datasource(), null, "datasource", null, 1, 1, AbstractSimulationConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(edp2DatasourceEClass, EDP2Datasource.class, "EDP2Datasource", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEDP2Datasource_Id(), ecorePackage.getEString(), "id", null, 0, 1, EDP2Datasource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
