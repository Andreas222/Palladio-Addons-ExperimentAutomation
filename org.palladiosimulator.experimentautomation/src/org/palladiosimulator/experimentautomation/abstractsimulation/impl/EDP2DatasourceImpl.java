 ...
 * @generated
 */
public abstract class EDP2DatasourceImpl extends MinimalEObjectImpl.Container implements EDP2Datasource {
    ...
    public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsimulationPackage.EDP2_DATASOURCE__ID, oldId, id));
	}
