...
public class AbstractsimulationAdapterFactory extends AdapterFactoryImpl {
    ...
    protected AbstractsimulationSwitch<Adapter> modelSwitch = new AbstractsimulationSwitch<Adapter>() {
			...
			@Override
			public Adapter caseEDP2Datasource(EDP2Datasource object) {
				return createEDP2DatasourceAdapter();
			}
			@Override
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.experimentautomation.abstractsimulation.AbstractSimulationConfiguration <em>Abstract Simulation Configuration</em>}'.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.experimentautomation.abstractsimulation.RandomNumberGeneratorSeed <em>Random Number Generator Seed</em>}'.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.experimentautomation.abstractsimulation.EDP2Datasource <em>EDP2 Datasource</em>}'.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.experimentautomation.abstractsimulation.MemoryDatasource <em>Memory Datasource</em>}'.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.experimentautomation.abstractsimulation.FileDatasource <em>File Datasource</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that
     * we can easily ignore cases; it's useful to ignore a case when inheritance will catch all the
     * cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.experimentautomation.abstractsimulation.MeasurementCountStopCondition <em>Measurement Count Stop Condition</em>}'.
	 * <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's useful to ignore a case
     * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.experimentautomation.abstractsimulation.SimTimeStopCondition <em>Sim Time Stop Condition</em>}'.
	 * <!-- begin-user-doc --> This default implementation
     * returns null so that we can easily ignore cases; it's useful to ignore a case when
     * inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.experimentautomation.abstractsimulation.StopCondition <em>Stop Condition</em>}'.
